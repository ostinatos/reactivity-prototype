...
window.appleWatcher = appleWatcher;
...
let nestedWatcher = new Watcher(() => `${foods.apple} ${basketAppleWatcher.value}`, (newVal, oldVal) => {
  console.debug("nestedWatcher watcher: new value:", newVal, ", old  value: ", oldVal)
})
